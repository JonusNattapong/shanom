---
description: Review code changes for Shanom-specific patterns, security, and common mistakes
---

Review the current changes (staged or working directory) with focus on Shanom-specific patterns and common mistakes.
...
## Step 2: Check Shanom-Specific Patterns
